...
const AddToys = () => {
  ...
  return (
    <>
    <Banner imageUrl={"https://wallpaperaccess.com/full/1225711.jpg"} title={"Add Toys"}/>
      <div className="container justify-center mx-auto p-12 bg-base-300 rounded-3xl mt-48">
        <div>
