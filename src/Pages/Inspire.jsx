const Inspire = () => {
  return (
    <div className="container mx-auto justify-center">
      <h1 data-aos="fade-down-right" className="text-3xl font-bold text-center mb-12">
          ...
          <div
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-md">
                <h1 className="mb-5 text-5xl font-bold">Marvel Studio</h1>
                <p className="mb-5">
                  Marvel Avengers team is our best inspirations because there
                  movies and characters give us a lots of idea to make toys
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-md">
                <h1 className="mb-5 text-5xl font-bold">Marvel Studio</h1>
                <p className="mb-5">
                  Marvel Avengers infinity war movie team is our best
                  inspirations because there movies and characters give us a
                  lots of idea to make toys
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-md">
                <h1 className="mb-5 text-5xl font-bold">Marvel Studio</h1>
                <p className="mb-5">
                  Marvel movie the age of Ultron is our best inspirations
                  because there movies and characters give us a lots of idea to
                  make toys
                </p>
              </div>
            </div>
